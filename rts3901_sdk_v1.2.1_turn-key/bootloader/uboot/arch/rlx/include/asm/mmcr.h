 ...
 * RXx281 MP MMCR definitions and marcos
 *
...
#define  MMCR_CORESTATE_ONLINE_BIT	1
#define  MMCR_CORESTATE_COHERENT_SHF	1
#define  MMCR_CORESTATE_COHERENT_BIT	1
#define  MMCR_CORESTATE_SLEEPING_SHF	8
...
#define MMCR_SMMU_CCA_KUSEG_SHF		0
#define MMCR_SMMU_CCA_KSEG0_SHF		16
#define MMCR_SMMU_CCA_KSEG1_SHF		21
#define MMCR_SMMU_CCA_KSEG2_SHF		27
...
#ifndef __ASSEMBLY__
extern int __init mmcr_init(void);
#endif
#endif /* _ASM_MMCR_H */
