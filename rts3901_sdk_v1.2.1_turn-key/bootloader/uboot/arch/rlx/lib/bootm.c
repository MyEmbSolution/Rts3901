...
static void boot_prep_linux(bootm_headers_t *images)
{
	...
	sprintf(env_buf, "%lu", (ulong)CPU_FREQUCNCY);
	linux_env_set("cpufreq", env_buf);
	...
	debug("## linux_env argv at 0x%p, argp at 0x%p\n",
	      linux_env, linux_env_p);
