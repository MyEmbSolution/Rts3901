...
#define PLL0_N_SETTING			0x24	/*1000M, PLL0 output = (N+4)*25000000 */

#define PLL2_N_SETTING			0x2c	/*1200M, PLL0 output = (N+4)*25000000 */

#ifdef CONFIG_CPU_600M
#define CPU_FREQUCNCY			600000000 /*PLL2/2*/
#endif
#ifdef CONFIG_CPU_500M
#define CPU_FREQUCNCY			500000000 /*PLL0/2*/
#endif
#ifdef CONFIG_CPU_400M
#define CPU_FREQUCNCY			400000000 /*PLL2/3*/
#endif
#ifdef CONFIG_CPU_333M
#define CPU_FREQUCNCY			333333333 /*PLL0/3*/
#endif
#ifdef CONFIG_CPU_300M
#define CPU_FREQUCNCY			300000000 /*PLL2/4*/
#endif
#ifdef CONFIG_CPU_250M
#define CPU_FREQUCNCY			250000000 /*PLL0/4*/
#endif
#ifdef CONFIG_CPU_240M
#define CPU_FREQUCNCY			240000000 /*PLL2/5*/
#endif
#ifdef CONFIG_CPU_200M
#define CPU_FREQUCNCY			200000000 /*PLL0/5*/
#endif
#endif
#endif
...
#ifdef CONFIG_DDR3_2GBIT_DEMOBOARD_GENERAL
#define CONFIG_DDR3_2GBIT_DEMOBOARD
/*#define CONFIG_DDR3_2GBIT_GENERAL_667M*/
#endif

#ifdef CONFIG_DDR3_1GBIT_DEMOBOARD_GENERAL
#define CONFIG_DDR3_1GBIT_DEMOBOARD
#endif

#define CONFIG_RXSETTING_PER_BYTE
#ifndef CONFIG_RXSETTING_PER_BYTE
#define CONFIG_RXSETTING_PER_BIT
#endif

#ifdef CONFIG_DDR3_2GBIT_QABOARD_V11
#define CONFIG_DDR3_2GBIT_QABOARD_V11_800M
#endif
#endif
