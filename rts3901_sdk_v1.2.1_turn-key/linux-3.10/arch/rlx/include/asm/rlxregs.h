...
#define CCTL_IMEM1FILL		0x00000010
#define CCTL_IMEM1OFF		0x00000020
#define CCTL_IMEM1ON		0x00000040
#define CCTL_DMEM1ON		0x00000400
#define CCTL_DMEM1OFF		0x00000800

/*
 * RLX CP3 register names
 */
#define LXCP3_IWBASE0		$0
#define LXCP3_IWTOP0		$1
#define LXCP3_IWBASE1		$2
#define LXCP3_IWTOP1		$3
#define LXCP3_DWBASE0		$4
#define LXCP3_DWTOP0		$5
#define LXCP3_DWBASE1		$6
#define LXCP3_DWTOP1		$7
...
/*
 * WMPU register values
 */
#define WMPU_WATCH_INSTRUCT		(1 << 2)
#define WMPU_WATCH_READ			(1 << 1)
#define WMPU_WATCH_WRITE		(1 << 0)
#define get_watch_write_value(addr)	(((addr) & ~0x7) | WMPU_WATCH_WRITE)
#define get_watch_read_value(addr)	(((addr) & ~0x7) | WMPU_WATCH_READ)
#define get_watch_rw_value(addr)	(((addr) & ~0x7) | WMPU_WATCH_READ \
		| WMPU_MATCH_WRITE)
#define get_watch_inst_value(addr)	(((addr) & ~0x7) | WMPU_MATCH_INSTRUCT)
#define WMPU_MORE_ENTRY			(1 << 31)
#define WMPU_GLOBAL_MATCH		(1 << 30)
#define WMPU_KERNELWATCH_ENABLE		(1 << 1)
#define WMPU_KERNELWATCH_DISABLE	(0 << 1)
#define WMPU_WATCHPOINT_MODE		(0 << 0)
#define WMPU_MEMORYPROTECT_MODE		(1 << 0)
