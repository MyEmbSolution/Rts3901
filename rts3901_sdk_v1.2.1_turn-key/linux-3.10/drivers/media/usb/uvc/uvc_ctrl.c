...
static struct uvc_control_info uvc_ctrls[] = {
	...
	/* Begin added by mingqian,2012/12/06, uvc1.5*/
	{
		.entity		= UVC_GUID_UVC_CAMERA,
		.selector	= UVC_CT_FOCUS_SIMPLE_CONTROL,
		.index		= 19,
		.size		= 1,
		.flags		= UVC_CTRL_FLAG_SET_CUR | UVC_CTRL_FLAG_GET_CUR
				| UVC_CTRL_FLAG_GET_DEF | UVC_CTRL_FLAG_RESTORE,
	...
	{
		.entity		= UVC_GUID_UVC_CAMERA,
		.selector	= UVC_CT_WINDOW_CONTROL,
		.index		= 20,
		.size		= 12,
		.flags		= UVC_CTRL_FLAG_SET_CUR | UVC_CTRL_FLAG_GET_CUR
	...
	{
		.entity		= UVC_GUID_UVC_PROCESSING,
		.selector	= UVC_PU_CONTRAST_AUTO_CONTROL,
		.index		= 18,
		.size		= 1,
		.flags		= UVC_CTRL_FLAG_SET_CUR | UVC_CTRL_FLAG_GET_CUR
				| UVC_CTRL_FLAG_GET_DEF | UVC_CTRL_FLAG_RESTORE,
	...
	},
	{
		...
		.index		= 6,
		.size		= 4,
		.flags		= UVC_CTRL_FLAG_SET_CUR | UVC_CTRL_FLAG_GET_RANGE
				| UVC_CTRL_FLAG_RESTORE,
	},
	{
		.entity		= UVC_GUID_UVC_ENCODING,
	...
	},
	{
		...
		.size		= 2,
		.flags		= UVC_CTRL_FLAG_SET_CUR | UVC_CTRL_FLAG_GET_CUR
				| UVC_CTRL_FLAG_GET_DEF | UVC_CTRL_FLAG_GET_MAX
				| UVC_CTRL_FLAG_RESTORE,
	},
	{
		.entity		= UVC_GUID_UVC_ENCODING,
...
static struct uvc_control_mapping uvc_ctrl_mappings[] = {
	...
	{
		.id		= V4L2_CID_PROFILE_TOOLSETING,
		.name		= "Profile Toolset bmSetting",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_PROFILE_TOOLSET_CONTROL,
		.size		= 8,
		.offset		= 32,
	...
	{
		.id		= V4L2_CID_VIDEO_RESOLUTION_WIDTH,
	...
	{
		.id		= V4L2_CID_VIDEO_RESOLUTION_HEIGHT,
	...
	{
		.id		= V4L2_CID_MIN_FRAME_INTERVAL,
	...
	{
		.id		= V4L2_CID_SLICE_CONFIG_SETTING,
		.name		= "Slice Config Setting",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_SLICE_MODE_CONTROL,
		.size		= 16,
		.offset		= 16,
	...
	{
		.id		= V4L2_CID_RATE_CONTROL_MODE,
		.name		= "Rate Control Mode",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_RATE_CONTROL_MODE_CONTROL,
		.size		= 8,
		.offset		= 0,
	...
	{
		.id		= V4L2_CID_QpPrime_I,
		.name		= "Quantization Parameter Prime_I",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_QUANTIZATION_PARAMS_CONTROL,
		.size		= 16,
		.offset		= 0,
	...
	{
		.id		= V4L2_CID_QpPrime_P,
		.name		= "Quantization Parameter Prime_P",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_QUANTIZATION_PARAMS_CONTROL,
		.size		= 16,
		.offset		= 16,
	...
	{
		.id		= V4L2_CID_QpPrime_B,
		.name		= "Quantization Parameter Prime_B",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_QUANTIZATION_PARAMS_CONTROL,
		.size		= 16,
		.offset		= 32,
	...
	{
		.id		= V4L2_CID_SYNC_Frame_Type,
		.name		= "Sync Frame Type",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_SYNC_REF_FRAME_CONTROL,
		.size		= 8,
		.offset		= 0,
	...
	{
		.id		= V4L2_CID_SYNC_Frame_Interval,
		.name		= "Sync Frame Interval",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_SYNC_REF_FRAME_CONTROL,
		.size		= 16,
		.offset		= 8,
	...
	{
		.id		= V4L2_CID_Gradual_Decode_Refresh,
		.name		= "Gradual Decode Refresh",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_SYNC_REF_FRAME_CONTROL,
		.size		= 8,
		.offset		= 24,
	...
	{
		.id		= V4L2_CID_LTR_BUFFER_NUM,
		.name		= "Number Host Control LTR Buffers",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_LTR_BUFFER_CONTROL,
		.size		= 8,
		.offset		= 0,
	...
	{
		.id		= V4L2_CID_LTR_BUFFER_PutAtPosition,
		.name		= "Put At Position In LTR Buffer",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_LTR_PICTURE_CONTROL,
		.size		= 8,
		.offset		= 0,
	...
	{
		.id		= V4L2_CID_SEI_PAYLOADTYPE_L,
		.name		= "SEI Message (Low)",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_SEI_PAYLOADTYPE_CONTROL,
		.size		= 32,
		.offset		= 0,
	...
	{
		.id		= V4L2_CID_SEI_PAYLOADTYPE_H,
		.name		= "Sei Message (High)",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_SEI_PAYLOADTYPE_CONTROL,
		.size		= 32,
		.offset		= 32,
	...
	{
		.id		= V4L2_CID_START_OR_STOP_LAYER,
		.name		= "Start or Stop Layer",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_START_OR_STOP_LAYER_CONTROL,
		.size		= 1,
		.offset		= 0,
	...
	{
		.id		= V4L2_CID_ERROR_RESILIENCY,
		.name		= "Error Resiliency Features",
		.entity		= UVC_GUID_UVC_ENCODING,
		.selector	= UVC_EU_ERROR_RESILIENCY_CONTROL,
		.size		= 16,
		.offset		= 0,
...
int uvc_ctrl_init_device(struct uvc_device *dev)
{
	...
	list_for_each_entry(entity, &dev->entities, list) {
		...
		} else if (UVC_ENTITY_TYPE(entity) == UVC_VC_ENCODING_UINT) {
			bControlSize = entity->encoding.bControlSize;
			/*all request to encoding unit before a successfull
			VS_COMMIT_CONTROL(SET_CUR),except GET_LEN,
			shall result in protocol STALL*/
			bmControls = entity->encoding.bmControlsRuntime;
		}
