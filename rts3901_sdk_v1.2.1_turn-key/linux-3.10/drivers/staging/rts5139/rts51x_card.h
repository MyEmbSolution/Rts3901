...
//SOF WDOG
#define SOF_WD_CNTEN		0x80
#define SOF_WD_EN			0x40
#define SOF_WD_TO_10ms	0x00
#define SOF_WD_TO_100ms	0x04
#define SOF_WD_TO_1s		0x08
#define SOF_WD_TO_10s		0x0c
#define SOF_WD_RELINK_10ms	0x00
#define SOF_WD_RELINK_100ms	0x01
#define SOF_WD_RELINK_1s		0x02
#define SOF_WD_RELINK_10s		0x03
...
// SD_CALCULATE_CRC7, SD_CHECK_CRC16, SD_NO_WAIT_BUSY_END, SD_NO_CHECK_CRC7, SD_RSP_LEN_0
#define	SD_RSP_TYPE_R0			0x04
// SD_CALCULATE_CRC7, SD_CHECK_CRC16, SD_NO_WAIT_BUSY_END, SD_CHECK_CRC7, SD_RSP_LEN_6
#define	SD_RSP_TYPE_R1			0x01
// SD_CALCULATE_CRC7, SD_CHECK_CRC16, SD_WAIT_BUSY_END, SD_CHECK_CRC7, SD_RSP_LEN_6
#define	SD_RSP_TYPE_R1b			0x09
// SD_CALCULATE_CRC7, SD_CHECK_CRC16, SD_NO_WAIT_BUSY_END, SD_CHECK_CRC7, SD_RSP_LEN_17
#define	SD_RSP_TYPE_R2			0x02
// SD_CALCULATE_CRC7, SD_CHECK_CRC16, SD_NO_WAIT_BUSY_END, SD_NO_CHECK_CRC7, SD_RSP_LEN_6
...
static inline int check_fake_card_ready(struct rts51x_chip *chip, unsigned int lun)
{
...
static inline void rts51x_clear_xd_error(struct rts51x_chip *chip)
{
	...
	//sangdy2010-05-04:flush fifo and reset DMA when r/w data error
