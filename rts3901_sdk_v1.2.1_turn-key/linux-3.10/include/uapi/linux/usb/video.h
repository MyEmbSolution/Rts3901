...
#define UVC_VS_FORMAT_YUV420				0x0e
...
struct uvc_encode_unit_descriptor {
	__u8 bLength;
	__u8 bDescriptorType;
	__u8 bDescriptorSubType;
	__u8 bUnitID;
...
#define UVC_DT_FORMAT_MPEGTS_SIZE			0x7
...
struct uvc_format_h264 {
	...
	__u8 Reserved1;
	__u16 bmSupportedRateControlModes;
...
#define UVC_DT_FORMAT_H264_SIZE			0x34
...
struct uvc_frame_h264 {
	...
	__u8 bmSupportedUsages[4];
	__u8 bmCapabilities[2];
	__u8 bmSVCCapabilities[4];
	__u8 bmMVCCapabilities[4];
	__u32 dwMinBitRate;
	__u32 dwMaxBitRate;
	__u32 dwDefaultFrameInterval;
...
struct uvc_format_yuv420 {
	__u8  bLength;
	__u8  bDescriptorType;
	__u8  bDescriptorSubType;
	__u8  bFormatIndex;
	__u8  bNumFrameDescriptors;
	__u8  guidMajorFormat[16];
	__u8  guidSubFormat[16];
	__u8  guidSpecifier[16];
	__u8  bPayloadClass;
	__u8  bDefaultFrameIndex;
	__u8  bCopyProtect;
} __attribute__((__packed__));

#define UVC_DT_FORMAT_YUV420_SIZE			0x38
...
#define UVC_DT_FRAME_YUV420_SIZE(n)			(26+4*(n))
