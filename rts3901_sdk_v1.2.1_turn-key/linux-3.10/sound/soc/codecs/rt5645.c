 ...
 */
static unsigned int rt5645_index_read(struct snd_soc_codec *codec,
				      unsigned int reg)
{
	int ret;
...
static unsigned rt5645_pdm1_read(struct snd_soc_codec *codec, unsigned int reg)
{
	int ret;
...
static int rt5645_volatile_register(struct snd_soc_codec *codec,
				    unsigned int reg)
{
	switch (reg) {
	case RT5645_RESET:
...
static int rt5645_readable_register(struct snd_soc_codec *codec,
				    unsigned int reg)
{
	switch (reg) {
	case RT5645_RESET:
...
void dc_calibrate(struct snd_soc_codec *codec)
{
	...
	sclk_src = snd_soc_read(codec, RT5645_GLB_CLK) & RT5645_SCLK_SRC_MASK;
	...
	snd_soc_update_bits(codec, RT5645_DEPOP_M1,
			    ...
			    RT5645_HP_CB_MASK,
			    RT5645_HP_CP_PU | RT5645_HP_SG_DIS |
			    RT5645_HP_CB_PU);
	...
	snd_soc_update_bits(codec, RT5645_PWR_ANLG2, RT5645_PWR_MB1, 0);
	snd_soc_update_bits(codec, RT5645_GLB_CLK,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_in1_mode_enum, RT5645_IN1_IN2,
				  RT5645_IN_SFT1, rt5645_input_mode);

static const SOC_ENUM_SINGLE_DECL(rt5645_in2_mode_enum, RT5645_IN3,
...
#if 1				/* Only for debug */
static const char * const rt5645_push_btn_mode[] = {
	"Disable", "read"
};

static const SOC_ENUM_SINGLE_DECL(rt5645_push_btn_enum, 0, 0,
				  rt5645_push_btn_mode);
...
static const char * const rt5645_jack_type_mode[] = {
	"Disable", "read"
};

static const SOC_ENUM_SINGLE_DECL(rt5645_jack_type_enum, 0, 0,
				  rt5645_jack_type_mode);
...
static const SOC_ENUM_SINGLE_DECL(rt5645_dac1l_enum, RT5645_AD_DA_MIXER,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_dac1r_enum, RT5645_AD_DA_MIXER,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_dac2l_enum, RT5645_DAC_CTRL,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_dac2r_enum, RT5645_DAC_CTRL,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_inl_enum, RT5645_INL1_INR1_VOL,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_inr_enum, RT5645_INL1_INR1_VOL,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_stereo1_adc1_enum,
				  RT5645_STO1_ADC_MIXER, RT5645_ADC_1_SRC_SFT,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_stereo1_adc2_enum,
				  RT5645_STO1_ADC_MIXER, RT5645_ADC_2_SRC_SFT,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_stereo1_dmic_enum,
				  RT5645_STO1_ADC_MIXER, RT5645_DMIC_SRC_SFT,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_mono_adc_l1_enum,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_mono_adc_l2_enum,
				  RT5645_MONO_ADC_MIXER,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_mono_dmic_l_enum,
				  RT5645_MONO_ADC_MIXER,
...
/* MX-28 [1:0] */
static const SOC_ENUM_SINGLE_DECL(rt5645_mono_dmic_r_enum,
				  RT5645_MONO_ADC_MIXER,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_mono_adc_r1_enum,
				  RT5645_MONO_ADC_MIXER,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_mono_adc_r2_enum,
				  RT5645_MONO_ADC_MIXER,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_if1_adc_in_enum, RT5645_TDM_CTRL_1,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_if2_adc_in_enum, RT5645_DIG_INF1_DATA,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_if3_adc_in_enum, RT5645_DIG_INF1_DATA,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_pdm1_l_enum, RT5645_PDM_OUT_CTRL,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_pdm1_r_enum, RT5645_PDM_OUT_CTRL,
...
static const SOC_ENUM_SINGLE_DECL(rt5645_vad_adc_enum, RT5645_VAD_CTRL4,
...
static void rt5645_pmu_depop(struct snd_soc_codec *codec)
{
	...
	snd_soc_update_bits(codec, RT5645_DEPOP_M1,
			    ...
			    RT5645_HP_R_SMT_MASK,
			    RT5645_RSTN_DIS | RT5645_HP_L_SMT_EN |
			    RT5645_HP_R_SMT_EN);
	snd_soc_update_bits(codec, RT5645_HP_VOL, RT5645_L_MUTE | RT5645_R_MUTE,
			    0);
	msleep(40);
	snd_soc_update_bits(codec, RT5645_DEPOP_M1,
			     ...
			     struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMD:
		snd_soc_update_bits(codec, RT5645_LOUT1,
				    RT5645_L_MUTE | RT5645_R_MUTE,
				    RT5645_L_MUTE | RT5645_R_MUTE);
		snd_soc_update_bits(codec, RT5645_PWR_ANLG1, RT5645_PWR_LM, 0);
		hp_amp_power(codec, 0);
		break;
