...
#define HAVE_abssi2 ((TARGET_RLX_RAD && !TARGET_MIPS16) && TARGET_RADIAX)
...
#define HAVE_mulsidi3_64bit (TARGET_64BIT && !ISA_HAS_DMUL3 && !TARGET_MIPS16)
#define HAVE_umulsidi3_64bit (TARGET_64BIT && !ISA_HAS_DMUL3 && !TARGET_MIPS16)
...
#define HAVE_umaddsidi4 ((TARGET_MAD || ISA_HAS_MACC || GENERATE_MADD_MSUB || ISA_HAS_DSP) \
   && !TARGET_64BIT)
#define HAVE_divmodsi4_internal (!TARGET_MIPS16)
#define HAVE_divmoddi4_internal ((!TARGET_MIPS16) && (TARGET_64BIT))
