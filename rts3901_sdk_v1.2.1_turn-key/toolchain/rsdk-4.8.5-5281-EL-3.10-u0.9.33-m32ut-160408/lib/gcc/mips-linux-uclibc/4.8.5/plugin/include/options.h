...
enum opt_code
{
  ...
  OPT_Wmissing_delay_slot = 276,             /* -Wmissing-delay-slot */
  ...
  OPT_Wpossible_load_use = 316,              /* -Wpossible-load-use */
  ...
  OPT_fdafile_relative = 524,                /* -fdafile-relative */
  ...
  OPT_fdeduce_init_list = 532,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 533,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 534, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 535,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 536,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 537,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 538,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 539,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 540,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 541,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_caret = 542,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 543,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 544,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 545,                /* -fdirectives-only */
  OPT_fdisable_ = 546,                       /* -fdisable- */
  OPT_fdisable_assertions = 547,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 548,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 549,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 550,         /* -fdollars-in-identifiers */
  OPT_fdse = 551,                            /* -fdse */
  OPT_fdump_ = 552,                          /* -fdump- */
  OPT_fdump_ada_spec = 553,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 554,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 555, */                /* -fdump-core */
  OPT_fdump_final_insns = 556,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 557,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 558,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 559,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 560,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 561,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 562,                /* -fdump-parse-tree */
  OPT_fdump_passes = 563,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 564,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 565,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 566,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 567,                 /* -fearly-inlining */
  ...
  OPT_ffix_bdsl = 600,                       /* -ffix-bdsl */
  OPT_ffixed_ = 601,                         /* -ffixed- */
  OPT_ffixed_form = 602,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 603,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 604,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 605,                    /* -ffloat-store */
  OPT_ffor_scope = 606,                      /* -ffor-scope */
  /* OPT_fforce_addr = 607, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 608,    /* -fforce-classes-archive-check */
  OPT_fforce_conv = 609,                     /* -fforce-conv */
  OPT_fforward_propagate = 610,              /* -fforward-propagate */
  OPT_ffp_contract_ = 611,                   /* -ffp-contract= */
  OPT_ffpe_trap_ = 612,                      /* -ffpe-trap= */
  OPT_ffree_form = 613,                      /* -ffree-form */
  OPT_ffree_line_length_ = 614,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 615,          /* -ffree-line-length-none */
  OPT_ffreestanding = 616,                   /* -ffreestanding */
  OPT_ffriend_injection = 617,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 618,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 619,                   /* -ffunction-cse */
  OPT_ffunction_sections = 620,              /* -ffunction-sections */
  OPT_fgcse = 621,                           /* -fgcse */
  OPT_fgcse_after_reload = 622,              /* -fgcse-after-reload */
  OPT_fgcse_las = 623,                       /* -fgcse-las */
  OPT_fgcse_lm = 624,                        /* -fgcse-lm */
  OPT_fgcse_sm = 625,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 626,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 627,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 628,                         /* -fgnu-tm */
  OPT_fgnu_unique = 629,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 630,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 631,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 632,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 633,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 634,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 635,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 636,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 637,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 638,                       /* -fgraphite */
  OPT_fgraphite_identity = 639,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 640,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 641, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 642, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 643,           /* -fhash-synchronization */
  /* OPT_fhelp = 644, */                     /* -fhelp */
  /* OPT_fhelp_ = 645, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 646,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 647, */                /* -fhonor-std */
  OPT_fhosted = 648,                         /* -fhosted */
  /* OPT_fhuge_objects = 649, */             /* -fhuge-objects */
  OPT_fident = 650,                          /* -fident */
  OPT_fif_conversion = 651,                  /* -fif-conversion */
  OPT_fif_conversion2 = 652,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 653,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 654,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 655,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 656,             /* -fimplicit-templates */
  OPT_findirect_classes = 657,               /* -findirect-classes */
  OPT_findirect_dispatch = 658,              /* -findirect-dispatch */
  OPT_findirect_inlining = 659,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 660,         /* -finhibit-size-directive */
  OPT_finit_character_ = 661,                /* -finit-character= */
  OPT_finit_integer_ = 662,                  /* -finit-integer= */
  OPT_finit_local_zero = 663,                /* -finit-local-zero */
  OPT_finit_logical_ = 664,                  /* -finit-logical= */
  OPT_finit_real_ = 665,                     /* -finit-real= */
  OPT_finline = 666,                         /* -finline */
  OPT_finline_atomics = 667,                 /* -finline-atomics */
  OPT_finline_functions = 668,               /* -finline-functions */
  OPT_finline_functions_called_once = 669,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 670, */            /* -finline-limit- */
  OPT_finline_limit_ = 671,                  /* -finline-limit= */
  OPT_finline_small_functions = 672,         /* -finline-small-functions */
  OPT_finput_charset_ = 673,                 /* -finput-charset= */
  OPT_finstrument_functions = 674,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 675,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 676,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 677,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 678,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 679,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 680,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 681,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 682, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 683,                    /* -fipa-profile */
  OPT_fipa_pta = 684,                        /* -fipa-pta */
  OPT_fipa_pure_const = 685,                 /* -fipa-pure-const */
  OPT_fipa_reference = 686,                  /* -fipa-reference */
  OPT_fipa_sra = 687,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 688, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 689,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 690,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 691,              /* -fira-loop-pressure */
  OPT_fira_region_ = 692,                    /* -fira-region= */
  OPT_fira_share_save_slots = 693,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 694,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 695,                   /* -fira-verbose= */
  OPT_fivopts = 696,                         /* -fivopts */
  OPT_fjni = 697,                            /* -fjni */
  OPT_fjump_tables = 698,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 699,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 700,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 701,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 702, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 703,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 704,             /* -fleading-underscore */
  OPT_floop_block = 705,                     /* -floop-block */
  /* OPT_floop_flatten = 706, */             /* -floop-flatten */
  OPT_floop_interchange = 707,               /* -floop-interchange */
  OPT_floop_nest_optimize = 708,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 709, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 710,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 711,                /* -floop-strip-mine */
  OPT_flto = 712,                            /* -flto */
  OPT_flto_compression_level_ = 713,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 714,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 715,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 716,              /* -flto-partition=max */
  OPT_flto_partition_none = 717,             /* -flto-partition=none */
  OPT_flto_report = 718,                     /* -flto-report */
  OPT_flto_ = 719,                           /* -flto= */
  OPT_fltrans = 720,                         /* -fltrans */
  OPT_fltrans_output_list_ = 721,            /* -fltrans-output-list= */
  OPT_fmain_ = 722,                          /* -fmain= */
  OPT_fmath_errno = 723,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 724,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 725,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 726,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 727,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 728,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 729,                     /* -fmem-report */
  OPT_fmem_report_wpa = 730,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 731,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 732,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 733,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 734,                /* -fmessage-length= */
  OPT_fmodule_private = 735,                 /* -fmodule-private */
  OPT_fmodulo_sched = 736,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 737,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 738,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 739,                  /* -fms-extensions */
  OPT_fmudflap = 740,                        /* -fmudflap */
  OPT_fmudflapir = 741,                      /* -fmudflapir */
  OPT_fmudflapth = 742,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 743, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 744, */                  /* -fnew-abi */
  OPT_fnext_runtime = 745,                   /* -fnext-runtime */
  OPT_fnil_receivers = 746,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 747, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 748,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 749,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 750, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 751,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 752,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 753,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 754,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 755,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 756,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 757,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 758,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 759,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 760,             /* -fomit-frame-pointer */
  OPT_fopenmp = 761,                         /* -fopenmp */
  OPT_foperator_names = 762,                 /* -foperator-names */
  OPT_fopt_info = 763,                       /* -fopt-info */
  OPT_fopt_info_ = 764,                      /* -fopt-info- */
  OPT_foptimize_register_move = 765,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 766,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 767,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 768,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 769, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 770,              /* -foutput-class-dir= */
  OPT_fpack_derived = 771,                   /* -fpack-derived */
  OPT_fpack_struct = 772,                    /* -fpack-struct */
  OPT_fpack_struct_ = 773,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 774,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 775,              /* -fpcc-struct-return */
  OPT_fpch_deps = 776,                       /* -fpch-deps */
  OPT_fpch_preprocess = 777,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 778,                     /* -fpeel-loops */
  OPT_fpeephole = 779,                       /* -fpeephole */
  OPT_fpeephole2 = 780,                      /* -fpeephole2 */
  OPT_fpermissive = 781,                     /* -fpermissive */
  OPT_fpic = 782,                            /* -fpic */
  OPT_fpie = 783,                            /* -fpie */
  OPT_fplan9_extensions = 784,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 785,                    /* -fplugin-arg- */
  OPT_fplugin_ = 786,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 787,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 788,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 789,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 790,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 791,                   /* -fpreprocessed */
  OPT_fpretty_templates = 792,               /* -fpretty-templates */
  OPT_fprofile = 793,                        /* -fprofile */
  OPT_fprofile_arcs = 794,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 795,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 796,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 797,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 798,              /* -fprofile-generate= */
  OPT_fprofile_report = 799,                 /* -fprofile-report */
  OPT_fprofile_use = 800,                    /* -fprofile-use */
  OPT_fprofile_use_ = 801,                   /* -fprofile-use= */
  OPT_fprofile_values = 802,                 /* -fprofile-values */
  OPT_fprotect_parens = 803,                 /* -fprotect-parens */
  OPT_frandom_seed = 804,                    /* -frandom-seed */
  OPT_frandom_seed_ = 805,                   /* -frandom-seed= */
  OPT_frange_check = 806,                    /* -frange-check */
  OPT_freal_4_real_10 = 807,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 808,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 809,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 810,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 811,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 812,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 813,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 814,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 815,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 816,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 817,                /* -frecord-marker=8 */
  OPT_frecursive = 818,                      /* -frecursive */
  OPT_freduced_reflection = 819,             /* -freduced-reflection */
  OPT_free = 820,                            /* -free */
  OPT_freg_struct_return = 821,              /* -freg-struct-return */
  OPT_fregmove = 822,                        /* -fregmove */
  OPT_frename_registers = 823,               /* -frename-registers */
  OPT_freorder_blocks = 824,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 825,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 826,              /* -freorder-functions */
  OPT_frepack_arrays = 827,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 828,           /* -freplace-objc-classes */
  OPT_frepo = 829,                           /* -frepo */
  OPT_frequire_return_statement = 830,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 831,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 832, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 833,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 834,                    /* -fresolution= */
  OPT_frlxcov = 835,                         /* -frlxcov */
  OPT_frounding_math = 836,                  /* -frounding-math */
  OPT_frtti = 837,                           /* -frtti */
  OPT_fsanitize_address = 838,               /* -fsanitize=address */
  OPT_fsanitize_thread = 839,                /* -fsanitize=thread */
  OPT_fsaw_java_file = 840,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 841,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 842,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 843,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 844,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 845,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 846,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 847,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 848,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 849,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 850,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 851,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 852,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 853,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 854,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 855,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 856,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 857,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 858, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 859,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 860,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 861,              /* -fsecond-underscore */
  OPT_fsection_anchors = 862,                /* -fsection-anchors */
  /* OPT_fsee = 863, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 864,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 865,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 866, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 867,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 868,          /* -fselective-scheduling2 */
  OPT_fshort_double = 869,                   /* -fshort-double */
  OPT_fshort_enums = 870,                    /* -fshort-enums */
  OPT_fshort_wchar = 871,                    /* -fshort-wchar */
  OPT_fshow_column = 872,                    /* -fshow-column */
  OPT_fshrink_wrap = 873,                    /* -fshrink-wrap */
  OPT_fsign_zero = 874,                      /* -fsign-zero */
  OPT_fsignaling_nans = 875,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 876,               /* -fsigned-bitfields */
  OPT_fsigned_char = 877,                    /* -fsigned-char */
  OPT_fsigned_zeros = 878,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 879,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 880,               /* -fsource-filename= */
  OPT_fsource_ = 881,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 882,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 883,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 884,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 885, */                 /* -fsquangle */
  OPT_fstack_arrays = 886,                   /* -fstack-arrays */
  /* OPT_fstack_check = 887, */              /* -fstack-check */
  OPT_fstack_check_ = 888,                   /* -fstack-check= */
  OPT_fstack_limit = 889,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 890,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 891,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 892,                /* -fstack-protector */
  OPT_fstack_protector_all = 893,            /* -fstack-protector-all */
  OPT_fstack_reuse_ = 894,                   /* -fstack-reuse= */
  OPT_fstack_usage = 895,                    /* -fstack-usage */
  OPT_fstats = 896,                          /* -fstats */
  OPT_fstore_check = 897,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 898, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 899,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 900,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 901,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 902, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 903,      /* -fstrict-volatile-bitfields */
  OPT_fsuppress_outer_loop_unroll = 904,     /* -fsuppress-outer-loop-unroll */
  OPT_fsync_libcalls = 905,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 906,                    /* -fsyntax-only */
  OPT_ftabstop_ = 907,                       /* -ftabstop= */
  /* OPT_ftarget_help = 908, */              /* -ftarget-help */
  OPT_ftarget_ = 909,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 910,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 911, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 912,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 913,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 914, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 915,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 916,             /* -fthreadsafe-statics */
  OPT_ftime_report = 917,                    /* -ftime-report */
  OPT_ftls_model_ = 918,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 919,               /* -ftoplevel-reorder */
  OPT_ftracer = 920,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 921,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 922,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 923,                  /* -ftrapping-math */
  OPT_ftrapv = 924,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 925,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 926,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 927,                       /* -ftree-ccp */
  OPT_ftree_ch = 928,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 929,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 930,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 931,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 932,                /* -ftree-copyrename */
  OPT_ftree_cselim = 933,                    /* -ftree-cselim */
  OPT_ftree_dce = 934,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 935,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 936,                       /* -ftree-dse */
  OPT_ftree_forwprop = 937,                  /* -ftree-forwprop */
  OPT_ftree_fre = 938,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 939,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 940,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 941,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 942,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 943,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 944,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 945, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 946,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 947,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 948,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 949,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 950,                   /* -ftree-phiprop */
  OPT_ftree_pre = 951,                       /* -ftree-pre */
  OPT_ftree_pta = 952,                       /* -ftree-pta */
  OPT_ftree_reassoc = 953,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 954, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 955,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 956,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 957,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 958,                      /* -ftree-slsr */
  OPT_ftree_sra = 959,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 960, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 961, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 962,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 963,                /* -ftree-tail-merge */
  OPT_ftree_ter = 964,                       /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 965, */   /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 966,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 967,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 968,                       /* -ftree-vrp */
  OPT_ftword = 969,                          /* -ftword */
  OPT_ftword_stack = 970,                    /* -ftword-stack */
  OPT_funderscoring = 971,                   /* -funderscoring */
  OPT_funit_at_a_time = 972,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 973,               /* -funroll-all-loops */
  OPT_funroll_loops = 974,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 975,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 976,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 977,             /* -funsigned-bitfields */
  OPT_funsigned_char = 978,                  /* -funsigned-char */
  OPT_funswitch_loops = 979,                 /* -funswitch-loops */
  OPT_funwind_tables = 980,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 981,            /* -fuse-atomic-builtins */
  OPT_fuse_balx = 982,                       /* -fuse-balx */
  OPT_fuse_boehm_gc = 983,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 984,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 985,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 986,          /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 987,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 988,                    /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 989,              /* -fuse-linker-plugin */
  OPT_fuse_tls = 990,                        /* -fuse-tls */
  OPT_fuse_uls = 991,                        /* -fuse-uls */
  OPT_fvar_tracking = 992,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 993,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 994,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 995,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 996, /* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 997, */          /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 998,               /* -fvect-cost-model= */
  OPT_fverbose_asm = 999,                    /* -fverbose-asm */
  /* OPT_fversion = 1000, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1001,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1002,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1003,                   /* -fvisibility= */
  OPT_fvpt = 1004,                           /* -fvpt */
  /* OPT_fvtable_gc = 1005, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1006, */           /* -fvtable-thunks */
  OPT_fweak = 1007,                          /* -fweak */
  OPT_fweb = 1008,                           /* -fweb */
  OPT_fwhole_file = 1009,                    /* -fwhole-file */
  OPT_fwhole_program = 1010,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1011,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1012,             /* -fworking-directory */
  OPT_fwpa = 1013,                           /* -fwpa */
  OPT_fwrapv = 1014,                         /* -fwrapv */
  /* OPT_fxref = 1015, */                    /* -fxref */
  /* OPT_fzee = 1016, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1017,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1018,                     /* -fzero-link */
  OPT_g = 1019,                              /* -g */
  OPT_gant = 1020,                           /* -gant */
  OPT_gcoff = 1021,                          /* -gcoff */
  OPT_gdwarf_ = 1022,                        /* -gdwarf- */
  OPT_gen_decls = 1023,                      /* -gen-decls */
  OPT_ggdb = 1024,                           /* -ggdb */
  OPT_gnat = 1025,                           /* -gnat */
  OPT_gnatO = 1026,                          /* -gnatO */
  OPT_gno_pubnames = 1027,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1028,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1029,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1030,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1031,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1032,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1033,                   /* -gsplit-dwarf */
  OPT_gstabs = 1034,                         /* -gstabs */
  OPT_gstabs_ = 1035,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1036,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1037,                        /* -gtoggle */
  OPT_gvms = 1038,                           /* -gvms */
  OPT_gxcoff = 1039,                         /* -gxcoff */
  OPT_gxcoff_ = 1040,                        /* -gxcoff+ */
  OPT_h = 1041,                              /* -h */
  OPT_idirafter = 1042,                      /* -idirafter */
  OPT_imacros = 1043,                        /* -imacros */
  OPT_imultiarch = 1044,                     /* -imultiarch */
  OPT_imultilib = 1045,                      /* -imultilib */
  OPT_include = 1046,                        /* -include */
  OPT_iplugindir_ = 1047,                    /* -iplugindir= */
  OPT_iprefix = 1048,                        /* -iprefix */
  OPT_iquote = 1049,                         /* -iquote */
  OPT_isysroot = 1050,                       /* -isysroot */
  OPT_isystem = 1051,                        /* -isystem */
  OPT_iwithprefix = 1052,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1053,              /* -iwithprefixbefore */
  OPT_k8 = 1054,                             /* -k8 */
  OPT_l = 1055,                              /* -l */
  OPT_lang_asm = 1056,                       /* -lang-asm */
  OPT_mabi_ = 1057,                          /* -mabi= */
  OPT_mabicalls = 1058,                      /* -mabicalls */
  OPT_mandroid = 1059,                       /* -mandroid */
  OPT_march_ = 1060,                         /* -march= */
  OPT_mbionic = 1061,                        /* -mbionic */
  OPT_mbranch_cost_ = 1062,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1063,                 /* -mbranch-likely */
  OPT_mce_ = 1064,                           /* -mce= */
  OPT_mcheck_zero_division = 1065,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1066,                /* -mcode-readable= */
  OPT_mcpu_ = 1067,                          /* -mcpu= */
  OPT_mdebug = 1068,                         /* -mdebug */
  OPT_mdebugd = 1069,                        /* -mdebugd */
  OPT_mdivide_breaks = 1070,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1071,                  /* -mdivide-traps */
  OPT_mdmx = 1072,                           /* -mdmx */
  OPT_mdouble_float = 1073,                  /* -mdouble-float */
  OPT_mdsp = 1074,                           /* -mdsp */
  OPT_mdspr2 = 1075,                         /* -mdspr2 */
  OPT_meb = 1076,                            /* -meb */
  OPT_mel = 1077,                            /* -mel */
  OPT_membedded_data = 1078,                 /* -membedded-data */
  OPT_mexplicit_relocs = 1079,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1080,                  /* -mextern-sdata */
  OPT_mflip_mips16 = 1081,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1082,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1083,                 /* -mfp-exceptions */
  OPT_mfp32 = 1084,                          /* -mfp32 */
  OPT_mfp64 = 1085,                          /* -mfp64 */
  OPT_mfused_madd = 1086,                    /* -mfused-madd */
  OPT_mglibc = 1087,                         /* -mglibc */
  OPT_mgp32 = 1088,                          /* -mgp32 */
  OPT_mgp64 = 1089,                          /* -mgp64 */
  OPT_mgpopt = 1090,                         /* -mgpopt */
  OPT_mhard_float = 1091,                    /* -mhard-float */
  OPT_minterlink_mips16 = 1092,              /* -minterlink-mips16 */
  OPT_mips = 1093,                           /* -mips */
  OPT_mips16 = 1094,                         /* -mips16 */
  ...
  OPT_mmac = 1101,                           /* -mmac */
  OPT_mmad = 1102,                           /* -mmad */
  OPT_mmcount_ra_address = 1103,             /* -mmcount-ra-address */
  OPT_mmcu = 1104,                           /* -mmcu */
  OPT_mmemcpy = 1105,                        /* -mmemcpy */
  OPT_mmt = 1106,                            /* -mmt */
  OPT_mmusl = 1107,                          /* -mmusl */
  OPT_mno_data_in_code = 1108,               /* -mno-data-in-code */
  ...
  OPT_mradiax = 1117,                        /* -mradiax */
  OPT_mrelax_pic_calls = 1118,               /* -mrelax-pic-calls */
  OPT_msave_restore_mmd = 1119,              /* -msave-restore-mmd */
  OPT_mshared = 1120,                        /* -mshared */
  OPT_msimd = 1121,                          /* -msimd */
  OPT_msingle_float = 1122,                  /* -msingle-float */
  OPT_msmartmips = 1123,                     /* -msmartmips */
  OPT_msoft_float = 1124,                    /* -msoft-float */
  OPT_msplit_addresses = 1125,               /* -msplit-addresses */
  OPT_msym32 = 1126,                         /* -msym32 */
  OPT_msynci = 1127,                         /* -msynci */
  OPT_mtune_ = 1128,                         /* -mtune= */
  OPT_muclibc = 1129,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1130,        /* -muninit-const-in-rodata */
  OPT_munsafe_zero_overhead = 1131,          /* -munsafe-zero-overhead */
  OPT_mxgot = 1132,                          /* -mxgot */
  OPT_mzero_overhead = 1133,                 /* -mzero-overhead */
  OPT_n = 1134,                              /* -n */
  OPT_no_canonical_prefixes = 1135,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1136,              /* -no-integrated-cpp */
  OPT_noasmopt = 1137,                       /* -noasmopt */
  OPT_nocpp = 1138,                          /* -nocpp */
  OPT_nodefaultlibs = 1139,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1140,                   /* -nostartfiles */
  OPT_nostdinc = 1141,                       /* -nostdinc */
  OPT_nostdinc__ = 1142,                     /* -nostdinc++ */
  OPT_nostdlib = 1143,                       /* -nostdlib */
  OPT_o = 1144,                              /* -o */
  OPT_p = 1145,                              /* -p */
  OPT_pass_exit_codes = 1146,                /* -pass-exit-codes */
  /* OPT_pedantic = 1147, */                 /* -pedantic */
  OPT_pedantic_errors = 1148,                /* -pedantic-errors */
  OPT_pg = 1149,                             /* -pg */
  OPT_pie = 1150,                            /* -pie */
  OPT_pipe = 1151,                           /* -pipe */
  OPT_posix = 1152,                          /* -posix */
  OPT_print_file_name_ = 1153,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1154,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1155,          /* -print-multi-directory */
  OPT_print_multi_lib = 1156,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1157,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1158,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1159,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1160,               /* -print-prog-name= */
  OPT_print_search_dirs = 1161,              /* -print-search-dirs */
  OPT_print_sysroot = 1162,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1163,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1164,                        /* -profile */
  OPT_pthread = 1165,                        /* -pthread */
  OPT_quiet = 1166,                          /* -quiet */
  OPT_r = 1167,                              /* -r */
  OPT_rdynamic = 1168,                       /* -rdynamic */
  OPT_remap = 1169,                          /* -remap */
  OPT_s = 1170,                              /* -s */
  OPT_s_bc_abi = 1171,                       /* -s-bc-abi */
  OPT_save_temps = 1172,                     /* -save-temps */
  OPT_save_temps_ = 1173,                    /* -save-temps= */
  OPT_shared = 1174,                         /* -shared */
  OPT_shared_libgcc = 1175,                  /* -shared-libgcc */
  /* OPT_specs = 1176, */                    /* -specs */
  OPT_specs_ = 1177,                         /* -specs= */
  OPT_static = 1178,                         /* -static */
  OPT_static_libasan = 1179,                 /* -static-libasan */
  OPT_static_libgcc = 1180,                  /* -static-libgcc */
  OPT_static_libgcj = 1181,                  /* -static-libgcj */
  OPT_static_libgfortran = 1182,             /* -static-libgfortran */
  OPT_static_libgo = 1183,                   /* -static-libgo */
  OPT_static_libstdc__ = 1184,               /* -static-libstdc++ */
  OPT_static_libtsan = 1185,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1186, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1187, */                /* -std=c++0x */
  OPT_std_c__11 = 1188,                      /* -std=c++11 */
  OPT_std_c__1y = 1189,                      /* -std=c++1y */
  OPT_std_c__98 = 1190,                      /* -std=c++98 */
  OPT_std_c11 = 1191,                        /* -std=c11 */
  /* OPT_std_c1x = 1192, */                  /* -std=c1x */
  /* OPT_std_c89 = 1193, */                  /* -std=c89 */
  OPT_std_c90 = 1194,                        /* -std=c90 */
  OPT_std_c99 = 1195,                        /* -std=c99 */
  /* OPT_std_c9x = 1196, */                  /* -std=c9x */
  OPT_std_f2003 = 1197,                      /* -std=f2003 */
  OPT_std_f2008 = 1198,                      /* -std=f2008 */
  OPT_std_f2008ts = 1199,                    /* -std=f2008ts */
  OPT_std_f95 = 1200,                        /* -std=f95 */
  OPT_std_gnu = 1201,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1202, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1203, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1204,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1205,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1206,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1207,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1208, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1209, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1210,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1211,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1212, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1213, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1214,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1215, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1216, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1217, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1218,                     /* -std=legacy */
  OPT_symbolic = 1219,                       /* -symbolic */
  OPT_t = 1220,                              /* -t */
  OPT_time = 1221,                           /* -time */
  OPT_time_ = 1222,                          /* -time= */
  OPT_tno_android_cc = 1223,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1224,                 /* -tno-android-ld */
  OPT_traditional = 1225,                    /* -traditional */
  OPT_traditional_cpp = 1226,                /* -traditional-cpp */
  OPT_trigraphs = 1227,                      /* -trigraphs */
  OPT_u = 1228,                              /* -u */
  OPT_undef = 1229,                          /* -undef */
  OPT_v = 1230,                              /* -v */
  OPT_version = 1231,                        /* -version */
  OPT_w = 1232,                              /* -w */
  OPT_wrapper = 1233,                        /* -wrapper */
  OPT_x = 1234,                              /* -x */
  OPT_z = 1235,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
