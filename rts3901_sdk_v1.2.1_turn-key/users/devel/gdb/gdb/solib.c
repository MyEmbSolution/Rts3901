...
`set solib-search-path'."),
  ...
  /* shunyen - set default solib-search-path from solib-absolute-prefix */
  solib_search_path = XNEWVEC (char, strlen(gdb_sysroot) + 4);
  memcpy (solib_search_path, gdb_sysroot, strlen(gdb_sysroot) + 1);
  solib_search_path = strcat (solib_search_path, "lib");
