...
void dump_adapters_status(void *sel, struct dvobj_priv *dvobj)
{
	...
	if (rfctl->radar_detect_ch != 0) {
		...
		DBG_871X_SEL(sel, ", dfs_domain:%u", rtw_odm_get_dfs_domain(dvobj->padapters[IFACE_ID0]));
