...
enum {
	ALSA_TS_TYPE_MONOTONIC	= 0,
	ALSA_TS_TYPE_REALTIME	= 1,
};
...
static int audio_read_packet(AVFormatContext *s1, AVPacket *pkt)
{
    ...
    if (ALSA_TS_TYPE_REALTIME == s->ts_type)
	    dts = av_gettime();
    else
...
static const AVOption options[] = {
    ...
    { "ts_type",     "", offsetof(AlsaData, ts_type),     AV_OPT_TYPE_INT, {.i64 = 0},     0, 1,       AV_OPT_FLAG_DECODING_PARAM },
    { NULL },
};
