/*
 * testusb_host.c (modified by testusb.c for zero driver)
 * aim to test usb host of IPcam
 * lei_wang (lei_wang@realsil.com.cn)
 * 20150706
 *
 * layers:
 * HOST ------> testusb_host.c
 * HOST ------> usb testing driver
 * |
 * |
 * |
 * DEVICE -----> zero driver

 * notice: HOST is usb host of IPcam
	   DEVICE is net2280 card in PC
 */
