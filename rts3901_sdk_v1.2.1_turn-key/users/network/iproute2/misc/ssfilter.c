...
#line 54 "ssfilter.y"
    {
		(yyval) = alloc_node(SSF_DCOND, (yyvsp[(2) - (2)]));
        ;}
    break;
...
#line 58 "ssfilter.y"
    {
		(yyval) = alloc_node(SSF_SCOND, (yyvsp[(2) - (2)]));
        ;}
    break;
...
#line 62 "ssfilter.y"
    {
                (yyval) = alloc_node(SSF_D_GE, (yyvsp[(3) - (3)]));
        ;}
    break;
...
#line 66 "ssfilter.y"
    {
                (yyval) = alloc_node(SSF_D_LE, (yyvsp[(3) - (3)]));
        ;}
    break;
...
#line 70 "ssfilter.y"
    {
                (yyval) = alloc_node(SSF_NOT, alloc_node(SSF_D_LE, (yyvsp[(3) - (3)])));
        ;}
    break;
...
#line 74 "ssfilter.y"
    {
                (yyval) = alloc_node(SSF_NOT, alloc_node(SSF_D_GE, (yyvsp[(3) - (3)])));
        ;}
    break;
...
#line 78 "ssfilter.y"
    {
		(yyval) = alloc_node(SSF_DCOND, (yyvsp[(3) - (3)]));
        ;}
    break;
...
#line 82 "ssfilter.y"
    {
		(yyval) = alloc_node(SSF_NOT, alloc_node(SSF_DCOND, (yyvsp[(3) - (3)])));
        ;}
    break;
...
#line 87 "ssfilter.y"
    {
                (yyval) = alloc_node(SSF_S_GE, (yyvsp[(3) - (3)]));
        ;}
    break;
...
#line 91 "ssfilter.y"
    {
                (yyval) = alloc_node(SSF_S_LE, (yyvsp[(3) - (3)]));
        ;}
    break;
...
#line 95 "ssfilter.y"
    {
                (yyval) = alloc_node(SSF_NOT, alloc_node(SSF_S_LE, (yyvsp[(3) - (3)])));
        ;}
    break;
...
#line 99 "ssfilter.y"
    {
                (yyval) = alloc_node(SSF_NOT, alloc_node(SSF_S_GE, (yyvsp[(3) - (3)])));
        ;}
    break;
...
#line 103 "ssfilter.y"
    {
		(yyval) = alloc_node(SSF_SCOND, (yyvsp[(3) - (3)]));
        ;}
    break;
...
#line 107 "ssfilter.y"
    {
		(yyval) = alloc_node(SSF_NOT, alloc_node(SSF_SCOND, (yyvsp[(3) - (3)])));
        ;}
    break;
...
#line 116 "ssfilter.y"
    {
                (yyval) = alloc_node(SSF_OR, (yyvsp[(1) - (3)]));
	        (yyval)->post = (yyvsp[(3) - (3)]);
        ;}
    break;
...
#line 121 "ssfilter.y"
    {
                (yyval) = alloc_node(SSF_AND, (yyvsp[(1) - (2)]));
	        (yyval)->post = (yyvsp[(2) - (2)]);
        ;}
    break;
...
#line 127 "ssfilter.y"
    {
                (yyval) = alloc_node(SSF_AND, (yyvsp[(1) - (3)]));
	        (yyval)->post = (yyvsp[(3) - (3)]);
        ;}
    break;
...
#line 132 "ssfilter.y"
    {
                (yyval) = alloc_node(SSF_NOT, (yyvsp[(2) - (2)]));
        ;}
    break;
