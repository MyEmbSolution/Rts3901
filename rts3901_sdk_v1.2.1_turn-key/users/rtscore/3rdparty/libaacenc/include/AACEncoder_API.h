...
int AACEncoder_API_Process(void *API , short* Input , char* Output , int InputLen);
...
int AACEncoder_API_Set(void* API , void* pParameters , int size , unsigned int IDs);
int AACEncoder_API_Get(void* API , void* pParameters , int size , unsigned int IDs);
