...
/* Rate control parameters */
	...
	i32 cvbr_en;
	i32 cvbr_diff_n;
	u8 cvbr_image_quality;
	i32 cvbr_max_bitrate;
	i32 cvbr_min_bitrate;
	i32 p_wnd_size;
	i32 p_target_min_percentage;
	i32 p_target_max_percentage;
	i32 p_diff_x_th_percentage;
	i32 p_diff_adjust_percentage;
